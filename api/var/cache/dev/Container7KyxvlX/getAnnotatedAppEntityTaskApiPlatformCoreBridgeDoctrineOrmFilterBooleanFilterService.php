 ...
 */
class getAnnotatedAppEntityTaskApiPlatformCoreBridgeDoctrineOrmFilterBooleanFilterService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'annotated_app_entity_task_api_platform_core_bridge_doctrine_orm_filter_boolean_filter' shared autowired service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['annotated_app_entity_task_api_platform_core_bridge_doctrine_orm_filter_boolean_filter'] = new \ApiPlatform\Core\Bridge\Doctrine\Orm\Filter\BooleanFilter(($container->services['doctrine'] ?? $container->getDoctrineService()), NULL, ($container->privates['monolog.logger'] ?? $container->getMonolog_LoggerService()), ['isPublished' => NULL], ($container->privates['serializer.name_converter.metadata_aware'] ?? $container->getSerializer_NameConverter_MetadataAwareService()));
    }
}
